...
export const LIVE_MATCHDAY_HIERARCHICAL_LAYOUT_POSITIONS = [
  ...
  },
  {
    ...
    group: "six_news",
    publicName: "6 notícias (1 dominante · 3 secundárias · 2 complementares) — dominante",
  },
  {
    ...
    group: "six_news",
    publicName: "6 notícias (1 dominante · 3 secundárias · 2 complementares) — secundária 1",
  },
  {
    ...
    slotKey: "secondary_1",
    group: "six_news",
    publicName: "6 notícias (1 dominante · 3 secundárias · 2 complementares) — secundária 2",
  },
  {
    ...
    slotKey: "secondary_2",
    group: "six_news",
    publicName: "6 notícias (1 dominante · 3 secundárias · 2 complementares) — secundária 3",
  },
  {
    ...
    group: "six_news",
    publicName: "6 notícias (1 dominante · 3 secundárias · 2 complementares) — complementar 1",
  },
  {
    ...
    group: "six_news",
    publicName: "6 notícias (1 dominante · 3 secundárias · 2 complementares) — complementar 2",
  },
  {
    ...
    publicName: "5 notícias (1 dominante · 1 secundária · 3 complementares) — dominante",
  },
  {
    ...
    slotKey: "secondary_4",
    group: "five_news_balanced",
    publicName: "5 notícias (1 dominante · 1 secundária · 3 complementares) — secundária",
  },
  {
    ...
    slotKey: "closing_1",
    group: "five_news_balanced",
    publicName: "5 notícias (1 dominante · 1 secundária · 3 complementares) — complementar 1",
  },
  {
    ...
    slotKey: "closing_2",
    group: "five_news_balanced",
    publicName: "5 notícias (1 dominante · 1 secundária · 3 complementares) — complementar 2",
  },
  {
    ...
    slotKey: "closing_3",
    group: "five_news_balanced",
    publicName: "5 notícias (1 dominante · 1 secundária · 3 complementares) — complementar 3",
  },
  ...HIERARCHICAL_BEYOND_MATCHDAY_POSITIONS.map((position) => ({
    ...
    group: "five_news_secondary" as const,
    publicName: position.sortOrder === 1
